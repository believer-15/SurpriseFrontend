    ...
    return(
        <>
            <footer className="flex flex-col text-white bg-[#000] font-merriweather"> {/* Make footer using Grid */}
                <div className="sm:max-w-6xl sm:w-full sm:mx-auto bg-[#000] flex flex-col sm:flex-row items-center justify-between mt-[3.125rem] overflow-hidden">
                    <div className="flex flex-col items-center justify-center gap-3 bg-[#000]" data-aos="fade-up">
                    ...
                    <div className="flex flex-col items-center justify-center gap-3 bg-[#000] mt-[3.125rem] sm:mt-0" data-aos="fade-up">
