...
function Contact() {
    ...
    const html = `<div className="bg-lime-300 font-merriweather border-2" id="successMessage">
                        <img src=${sampleGif} alt="Sample GIF" style={{ width: '330px' }} />
                        <p className='text-base'>Thank you! We'll reach out to you shortly.</p>
                  </div>`;
    ...
    async function handleFormSubmit(e){
        ...
        if (validateField()) {
            ...
            // setFormState({ name: "", email: "", mobileNumber: "", selectedOption: "" }); // Clear the form
    ...
    const validateField = () => {
        ...
        if (!formState.email_id.trim()) {
            ...
            newErrors.email_id = "Enter Valid Email";
        }
